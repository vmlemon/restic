...
// nodeRestoreExtendedAttributes is a no-op on DragonFlyBSD.
func nodeRestoreExtendedAttributes(_ *restic.Node, _ string) error {
	return nil
}

// nodeFillExtendedAttributes is a no-op on DragonFlyBSD.
func nodeFillExtendedAttributes(_ *restic.Node, _ string, _ bool) error {
	return nil
}

// nodeRestoreGenericAttributes is no-op on DragonFlyBSD.
